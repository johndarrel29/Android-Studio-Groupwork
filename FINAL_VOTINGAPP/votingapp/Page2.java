...
public class Page2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                chosenPresident = Arrays.stream(chosenPresident.toLowerCase().split("\\s+")).map(word -> word.substring(0, 1).toUpperCase() + word.substring(1)).collect(Collectors.joining(" "));

                String chosenVicePresident = inputVicePresident.getText().toString().trim();
                chosenVicePresident = Arrays.stream(chosenVicePresident.toLowerCase().split("\\s+")).map(word -> word.substring(0, 1).toUpperCase() + word.substring(1)).collect(Collectors.joining(" "));
    ...
    public boolean tallyVote(String presidentCandidate, String vicePresidentCandidate) {
        ...
        if (presidentCandidate.isEmpty() || presidentCandidate.isBlank() || vicePresidentCandidate.isEmpty() || vicePresidentCandidate.isBlank()) {
            Toast.makeText(Page2.this, "Fields should not be empty!", Toast.LENGTH_SHORT).show();
            return false;
        }
        else {
            ...
            if (presidentCandidate.equalsIgnoreCase(candidatePresident1.getName())) {
                ...
                Toast.makeText(Page2.this, "Invalid President Candidate!", Toast.LENGTH_SHORT).show();
                return false;
            }
            ...
            if (vicePresidentCandidate.equalsIgnoreCase(candidateVicePresident1.getName())) {
                ...
                Toast.makeText(Page2.this, "Invalid Vice President Candidate!", Toast.LENGTH_SHORT).show();
                return false;
            }
        }
        return true;
